    ...
    <>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 max-w-4xl mx-auto py-20 relative" aria-labelledby="hero-title">
        ...
        <div className="w-20 h-10 mb-12 relative z-10" aria-hidden="true">
          <svg viewBox="0 0 80 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" role="img" aria-label="Oracle eye symbol">
        ...
        <button
          ...
          aria-label={!user ? 'Sign in to start' : hasKey === false ? 'Connect API key' : 'Start Oracle session'}
        >
        ...
        {hasKey === false && (
          <p className="mt-4 text-xs text-text-muted max-w-md text-center">
            Oracle requires a paid Google Cloud API key for visual generation. 

...
const FEATURES = [
  ...
  { icon: '🌙', title: 'Night Oracle', desc: 'A stripped-back, 3am-safe mode. Dark UI, no navigation, just a single question glowing on screen. Auto-activates between midnight and 5am.', color: 'gold' },
];
...
export function FeaturesSection() {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4" role="list" aria-label="Oracle features">

...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.googleapis.com https://*.firebaseio.com https://*.stripe.com wss://*.firebaseio.com https://api.anthropic.com https://api.together.xyz https://generativelanguage.googleapis.com https://*.elevenlabs.io wss://*.elevenlabs.io wss://*.livekit.cloud",

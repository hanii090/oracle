...
export const metadata: Metadata = {
  title: 'Terms of Service — Oracle',
  description: 'Oracle terms of service and conditions of use.',
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none font-cormorant text-lg text-text-mid space-y-8">
          <section>
            ...
            <p>By accessing or using Oracle (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.</p>
          </section>

          <section>
            <h2 className="font-cinzel text-xl text-text-main mb-4">2. Description of Service</h2>
            <p>Oracle is an AI-powered reflective questioning tool designed to facilitate self-discovery through Socratic dialogue. Oracle does not provide medical, psychological, or therapeutic advice. It is not a substitute for professional mental health services.</p>
          </section>
          ...
          <section>
            ...
            <p><strong>Oracle Pro (£49/month):</strong> Professional tier with client management (coming soon).</p>
          ...
          <section>
            ...
            <p>You retain ownership of all content you submit during sessions. Oracle stores your session data to provide the Thread feature. You may delete your data at any time by contacting us.</p>
          </section>

          <section>
            <h2 className="font-cinzel text-xl text-text-main mb-4">6. Prohibited Use</h2>
            <p>You must not use Oracle to: generate harmful content; attempt to bypass rate limits or security measures; reverse-engineer the service; or use the service in any way that violates applicable law.</p>
          </section>

          <section>
            <h2 className="font-cinzel text-xl text-text-main mb-4">7. Disclaimer</h2>
            <p>Oracle is provided &quot;as is&quot; without warranties. We do not guarantee uninterrupted access. AI-generated responses may be inaccurate or inappropriate. Use at your own discretion.</p>
          </section>

          <section>
            <h2 className="font-cinzel text-xl text-text-main mb-4">8. Limitation of Liability</h2>
            <p>To the maximum extent permitted by law, Oracle and its creators shall not be liable for any indirect, incidental, or consequential damages arising from use of the Service.</p>
          </section>

...
<svg viewBox="0 0 700 180" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:600px;margin:2rem auto;display:block"><text x="350" y="25" text-anchor="middle" fill="#0e0c09" font-size="13" font-weight="600">Mood Patterns Over 4 Weeks</text><line x1="60" y1="40" x2="60" y2="155" stroke="#c5bba8" stroke-width="1"/><line x1="60" y1="155" x2="660" y2="155" stroke="#c5bba8" stroke-width="1"/><text x="50" y="55" text-anchor="end" fill="#635a4c" font-size="9">😊</text><text x="50" y="100" text-anchor="end" fill="#635a4c" font-size="9">😐</text><text x="50" y="150" text-anchor="end" fill="#635a4c" font-size="9">😞</text><polyline points="80,120 100,105 120,115 140,95 160,100 180,85 200,90 220,80 240,95 260,75 280,85 300,70 320,80 340,65 360,75 380,60 400,70 420,55 440,65 460,58 480,50 500,60 520,48 540,55 560,45 580,52 600,42 620,48 640,40" fill="none" stroke="#b45309" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" opacity="0.8"/><rect x="80" y="162" width="140" height="12" rx="2" fill="#b45309" opacity="0.1"/><text x="150" y="171" text-anchor="middle" fill="#635a4c" font-size="8">Week 1</text><rect x="220" y="162" width="140" height="12" rx="2" fill="#b45309" opacity="0.15"/><text x="290" y="171" text-anchor="middle" fill="#635a4c" font-size="8">Week 2</text><rect x="360" y="162" width="140" height="12" rx="2" fill="#b45309" opacity="0.2"/><text x="430" y="171" text-anchor="middle" fill="#635a4c" font-size="8">Week 3</text><rect x="500" y="162" width="140" height="12" rx="2" fill="#b45309" opacity="0.25"/><text x="570" y="171" text-anchor="middle" fill="#635a4c" font-size="8">Week 4</text></svg>
...
<svg viewBox="0 0 700 200" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:600px;margin:2rem auto;display:block"><rect x="10" y="10" width="680" height="180" rx="16" fill="#b45309" opacity="0.04" stroke="#b45309" stroke-width="1.5"/><text x="350" y="45" text-anchor="middle" fill="#b45309" font-size="14" font-weight="600">The Between-Session Support Cycle</text><circle cx="120" cy="120" r="40" fill="#b45309" opacity="0.1" stroke="#b45309" stroke-width="1.5"/><text x="120" y="115" text-anchor="middle" fill="#b45309" font-size="10" font-weight="600">Therapy</text><text x="120" y="130" text-anchor="middle" fill="#635a4c" font-size="9">Session</text><circle cx="300" cy="120" r="40" fill="#b45309" opacity="0.15" stroke="#b45309" stroke-width="1.5"/><text x="300" y="115" text-anchor="middle" fill="#b45309" font-size="10" font-weight="600">Practice</text><text x="300" y="130" text-anchor="middle" fill="#635a4c" font-size="9">& Reflection</text><circle cx="480" cy="120" r="40" fill="#b45309" opacity="0.2" stroke="#b45309" stroke-width="1.5"/><text x="480" y="115" text-anchor="middle" fill="#b45309" font-size="10" font-weight="600">Progress</text><text x="480" y="130" text-anchor="middle" fill="#635a4c" font-size="9">& Insight</text><line x1="162" y1="120" x2="258" y2="120" stroke="#b45309" stroke-width="1.5" marker-end="url(#arrow)"/><line x1="342" y1="120" x2="438" y2="120" stroke="#b45309" stroke-width="1.5" marker-end="url(#arrow)"/><path d="M520 100 C580 60, 640 80, 640 120 C640 160, 580 180, 520 140" stroke="#b45309" stroke-width="1" stroke-dasharray="4 3" fill="none"/><text x="610" y="120" text-anchor="middle" fill="#635a4c" font-size="8">Repeat</text><defs><marker id="arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto"><path d="M 0 0 L 10 5 L 0 10 z" fill="#b45309"/></marker></defs></svg>

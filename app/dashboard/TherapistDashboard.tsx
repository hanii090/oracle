                        ...
                        >
                          <div className="p-4 space-y-4">
                            ...
                            <div className="grid grid-cols-3 sm:grid-cols-7 gap-2">
                              ...
                              <a
                                href={`/dashboard/voice-review?client=${client.id}`}
                                className="flex flex-col items-center gap-1 p-2.5 rounded-lg bg-amber-500/5 border border-amber-500/20 hover:bg-amber-500/10 transition-colors"
                              >
                                <svg className="w-4 h-4 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" /></svg>
                                <span className="text-[9px] text-amber-400 font-cinzel">Voice</span>
                              </a>
                              <button
